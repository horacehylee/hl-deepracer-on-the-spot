...
class Reward:
    ...
    def closest_2_racing_points_index(self, racing_coords, car_coords):
        ...
        for i in range(len(racing_coords)):
            distance = self.dist_2_points(x1=racing_coords[i][0], x2=car_coords[0],
    ...
    def dist_to_racing_line(self, closest_coords, second_closest_coords, car_coords):

        # Calculate the distances between 2 closest racing points
        a = abs(self.dist_2_points(x1=closest_coords[0],
                                   x2=second_closest_coords[0],
                                   y1=closest_coords[1],
                                   y2=second_closest_coords[1]))

        # Distances between car and closest and second closest racing point
        b = abs(self.dist_2_points(x1=car_coords[0],
                                   x2=closest_coords[0],
                                   y1=car_coords[1],
                                   y2=closest_coords[1]))
        c = abs(self.dist_2_points(x1=car_coords[0],
                                   x2=second_closest_coords[0],
                                   y1=car_coords[1],
                                   y2=second_closest_coords[1]))
    ...
    def next_prev_racing_point(self, closest_coords, second_closest_coords, car_coords, heading):
        ...
        distance_closest_coords_new = self.dist_2_points(x1=new_car_coords[0],
                                                         x2=closest_coords[0],
                                                         y1=new_car_coords[1],
                                                         y2=closest_coords[1])
        distance_second_closest_coords_new = self.dist_2_points(x1=new_car_coords[0],
                                                                x2=second_closest_coords[0],
                                                                y1=new_car_coords[1],
                                                                y2=second_closest_coords[1])
    ...
    def racing_direction_diff(self, closest_coords, second_closest_coords, car_coords, heading):

        # Calculate the direction of the center line based on the closest waypoints
        next_point, prev_point = self.next_prev_racing_point(closest_coords,
    ...
    def reward_function(self, params):
        ...
        closest_index, second_closest_index = self.closest_2_racing_points_index(
            racing_track, [x, y])
        ...
        direction_diff = self.racing_direction_diff(
